...
public class OutputFunctionTest extends JPanel {
    ...
    public OutputFunctionTest(Class tester, Method method) {
        this.method = method;
        this.tester = tester;
        initComponents();
...
//            panParam.add(txtParam, gridBagConstraints);
    ...
    private void initComponents() {
        ...
        cmdGo.setForeground(javax.swing.UIManager.getDefaults().getColor("CheckBoxMenuItem.acceleratorSelectionBackground"));
        cmdGo.setText(org.openide.util.NbBundle.getMessage(OutputFunctionTest.class, "OutputFunctionTest.cmdGo.text_1")); // NOI18N
