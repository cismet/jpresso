            ...
            public final Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
                ...
                if (value != null) {
                    ...
                    if (chars.length > 1 && deduplicate[column]) {
                        ...
                        c = super.getTableCellRendererComponent(table, new String(res, 0, ++ptr), isSelected, hasFocus, row, column);
                    } else {
                        c = super.getTableCellRendererComponent(table, new String(chars, 0, chars.length), isSelected, hasFocus, row, column);
                    }
...
//    }
    ...
    private void initComponents() {
        ...
        lblRowCount.setText(org.openide.util.NbBundle.getMessage(OutputIntermedTable.class, "OutputIntermedTable.lblRowCount.text")); // NOI18N
        ...
        jButton1.setText(org.openide.util.NbBundle.getMessage(OutputIntermedTable.class, "OutputIntermedTable.jButton1.text")); // NOI18N
        ...
        jTextField1.setText(org.openide.util.NbBundle.getMessage(OutputIntermedTable.class, "OutputIntermedTable.jTextField1.text")); // NOI18N
        ...
        jButton2.setText(org.openide.util.NbBundle.getMessage(OutputIntermedTable.class, "OutputIntermedTable.jButton2.text")); // NOI18N
...
private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    if (tblIntermed != null) {
        int[] x = tblIntermed.getSelectedColumns();
        int[] y = tblIntermed.getSelectedRows();
        for (int i : y) {
            for (int j : x) {
