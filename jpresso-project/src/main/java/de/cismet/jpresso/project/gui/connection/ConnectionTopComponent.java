...
//    static final String ICON_PATH = "SET/PATH/TO/ICON/HERE";
    ...
    public ConnectionTopComponent(ConnectionDataObject data) {
        super(data);
        initComponents();
...
//        setIcon(Utilities.loadImage(ICON_PATH, true));
        for (Document d : dbe.getDocuments()) {
            if (d != null) {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/jpresso/project/res/connection-established.png"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/jpresso/project/res/search.png"))); // NOI18N
