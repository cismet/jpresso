...
/**
 * Editor for the project's options,
 * like additional ClassPath and Driver.
 * 
 * @author  srichter
 */
...
//                    log.debug("D&D problem!", t);
    ...
    private void initComponents() {
        ...
        panOptions.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createTitledBorder(null, org.openide.util.NbBundle.getMessage(ProjectOptionsEditor.class, "ProjectOptionsEditor.panOptions.border.outsideBorder.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 12), javax.swing.UIManager.getDefaults().getColor("CheckBoxMenuItem.selectionBackground")), javax.swing.BorderFactory.createEmptyBorder(5, 5, 5, 5))); // NOI18N
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createTitledBorder(null, org.openide.util.NbBundle.getMessage(ProjectOptionsEditor.class, "ProjectOptionsEditor.jPanel1.border.outsideBorder.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 12), javax.swing.UIManager.getDefaults().getColor("CheckBoxMenuItem.selectionBackground")), javax.swing.BorderFactory.createEmptyBorder(5, 5, 5, 5))); // NOI18N
        jPanel1.setLayout(new java.awt.BorderLayout());

        jTextField1.setText(org.openide.util.NbBundle.getMessage(ProjectOptionsEditor.class, "ProjectOptionsEditor.jTextField1.text")); // NOI18N
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createTitledBorder(null, org.openide.util.NbBundle.getMessage(ProjectOptionsEditor.class, "ProjectOptionsEditor.jPanel2.border.outsideBorder.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 12), javax.swing.UIManager.getDefaults().getColor("CheckBoxMenuItem.selectionBackground")), javax.swing.BorderFactory.createEmptyBorder(5, 5, 5, 5))); // NOI18N
        ...
        jButton2.setText(org.openide.util.NbBundle.getMessage(ProjectOptionsEditor.class, "OptionsTopComponent.jButton2.text_1")); // NOI18N
        ...
        jButton5.setText(org.openide.util.NbBundle.getMessage(ProjectOptionsEditor.class, "OptionsTopComponent.jButton5.text")); // NOI18N
        ...
        jTabbedPane1.addTab(org.openide.util.NbBundle.getMessage(ProjectOptionsEditor.class, "OptionsTopComponent.panOptions.TabConstraints.tabTitle"), panOptions); // NOI18N
        ...
        jTabbedPane1.addTab(org.openide.util.NbBundle.getMessage(ProjectOptionsEditor.class, "OptionsTopComponent.panDrv.TabConstraints.tabTitle"), panDrv); // NOI18N

        panClasspath.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createTitledBorder(null, org.openide.util.NbBundle.getMessage(ProjectOptionsEditor.class, "ProjectOptionsEditor.panClasspath.border.outsideBorder.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 12), javax.swing.UIManager.getDefaults().getColor("CheckBoxMenuItem.selectionBackground")), javax.swing.BorderFactory.createEmptyBorder(5, 5, 5, 5))); // NOI18N
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/jpresso/project/res/edit-add.png"))); // NOI18N
        jButton3.setText(org.openide.util.NbBundle.getMessage(ProjectOptionsEditor.class, "OptionsTopComponent.jButton3.text")); // NOI18N
        jButton3.setToolTipText(org.openide.util.NbBundle.getMessage(ProjectOptionsEditor.class, "ProjectOptionsEditor.jButton3.toolTipText")); // NOI18N
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/jpresso/project/res/edit-delete.png"))); // NOI18N
        jButton4.setText(org.openide.util.NbBundle.getMessage(ProjectOptionsEditor.class, "OptionsTopComponent.jButton4.text")); // NOI18N
        jButton4.setToolTipText(org.openide.util.NbBundle.getMessage(ProjectOptionsEditor.class, "ProjectOptionsEditor.jButton4.toolTipText")); // NOI18N
        ...
        jTabbedPane1.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(ProjectOptionsEditor.class, "ProjectOptionsEditor.jTabbedPane1.AccessibleContext.accessibleName")); // NOI18N
    ...
    public ProjectOptions getContent() {
        ...
        final ProjectOptions ret = new ProjectOptions(getClassPathFiles(), panDriver.getDriverList(), jTextField1.getText(), p);
        return ret;
    }
