    ...
    public OutputInitializing(InitializingException iEx) {
        ...
        if (iEx.getCause() != null) {
            ...
            if (iEx.getCause() instanceof DynamicCompilingException) {
                ...
                if ((dex.getDetails() != null && dex.getDetails().size() > 0) || (dex.getPossibleErr() != null && dex.getPossibleErr().size() > 0)) {
                    txtOut.append("\n\nPossible error source(s):\n");
                } else {
                    return;
                }
                if (dex.getDetails() != null) {
                    for (String s : dex.getDetails()) {
                        detail.append(s);
                    }
                ...
                if (dex.getPossibleErr() != null) {
                    for (String s : dex.getPossibleErr()) {
                        txtOut.append("\n\t>> " + s);
//                }
                    }
                }
...
//    public List<String> getPossibleErrors(Iterator<Diagnostic<? extends JavaFileObject>> it) {
//        List<String> erg = new ArrayList<String>();
//        while (it.hasNext()) {
//            Diagnostic d = it.next();
//            FileObject fo = (FileObject) d.getSourceCode();
//            String[] errs = fo.getCharContent(true).toString().split("\n");
//            if (d.getKind() == Diagnostic.Kind.ERROR) {
////                        errorLines.add(d.getLineNumber());
//                erg.add(errs[new Long(d.getLineNumber()).intValue() - 1].trim());
//            }
////                    System.out.println("code:" + d.getCode());
////                    System.out.println("line:" + d.getLineNumber());
////                    System.out.println("column:" + d.getColumnNumber());
////                    System.out.println("message:" + d.getMessage(Locale.getDefault()));
////                    System.out.println("kind:" + d.getKind());
////                    System.out.println("position:" + d.getPosition());
////                    System.out.println("sposition:" + d.getStartPosition());
////                    System.out.println("eposition:" + d.getEndPosition());
////                    System.out.println(d);
////                    System.out.println(d.toString().toUpperCase());
////                    System.out.println("aaa " + d.getSourceCode().getClass());
//
//        }
//        return erg;
//    }
    public OutputInitializing(String out, String log) {
        initComponents();
        setName("Init Output");
...
//        scpDetail.setVisible(false);
    ...
    private void initComponents() {
        ...
        tbpMain.addTab(org.openide.util.NbBundle.getMessage(OutputInitializing.class, "OutputInitializing.scpOut.TabConstraints.tabTitle_1"), scpOut); // NOI18N
        ...
        tbpMain.addTab(org.openide.util.NbBundle.getMessage(OutputInitializing.class, "OutputInitializing.scpDetail.TabConstraints.tabTitle_1"), scpDetail); // NOI18N
