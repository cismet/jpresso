...
public class OutputDatabaseConnection extends TopComponentFinderPanel {
    ...
    private void initComponents() {
        ...
        mnuAddToMappings.setText(org.openide.util.NbBundle.getMessage(OutputDatabaseConnection.class, "OutputDatabaseConnection.mnuAddToMappings.text_1")); // NOI18N
        ...
        mnuAddToMappings.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(OutputDatabaseConnection.class, "OutputDatabaseConnection.mnuAddToMappings.AccessibleContext.accessibleName")); // NOI18N

        popMain.add(jSeparator1);

        mnuAddToRelations.setText(org.openide.util.NbBundle.getMessage(OutputDatabaseConnection.class, "OutputDatabaseConnection.mnuAddToRelations.text_1")); // NOI18N
        ...
        jMenuItem1.setText(org.openide.util.NbBundle.getMessage(OutputDatabaseConnection.class, "OutputDatabaseConnection.jMenuItem1.text")); // NOI18N
        ...
        jMenuItem2.setText(org.openide.util.NbBundle.getMessage(OutputDatabaseConnection.class, "OutputDatabaseConnection.jMenuItem2.text")); // NOI18N
        ...
        systemRenderer.setOpenIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/jpresso/project/res/sysdb.gif")));
        systemRenderer.setClosedIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/jpresso/project/res/sysdb_c.gif")));
        systemRenderer.setLeafIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/jpresso/project/res/rem_co.gif")));
        ...
        tabMain.addTab(org.openide.util.NbBundle.getMessage(OutputDatabaseConnection.class, "OutputDatabaseConnection.scpSystem.TabConstraints.tabTitle_2"), scpSystem); // NOI18N
        ...
        cidsRenderer.setOpenIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/jpresso/project/res/class_obj.gif")));
        cidsRenderer.setClosedIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/jpresso/project/res/innerclass_protected_obj.gif")));
        cidsRenderer.setLeafIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/jpresso/project/res/protected_co.gif")));
        ...
        tabMain.addTab(org.openide.util.NbBundle.getMessage(OutputDatabaseConnection.class, "OutputDatabaseConnection.panCids.TabConstraints.tabTitle_1"), panCids); // NOI18N
    ...
    private String promptFileName() {
        NotifyDescriptor.InputLine desc = new NotifyDescriptor.InputLine("Enter name", "Create new Import");
    ...
    private void createFiles(final Query qry, final JPressoRun run, final String name, final String path) {
        try {
            final File q = new File(path + File.separator + JPressoFileManager.DIR_QRY + File.separator + name + "." + JPressoFileManager.END_QUERY);
            final File r = new File(path + File.separator + JPressoFileManager.DIR_RUN + File.separator + name + "." + JPressoFileManager.END_RUN);
            if (q.isFile()) {
                if (JOptionPane.showConfirmDialog(this, "Query file already exists. Overwrite?", "Query file already exists", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
            ...
            if (r.isFile()) {
                if (JOptionPane.showConfirmDialog(this, "Run file already exists. Overwrite?", "Run file already exists", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
    ...
    private void handlePopupEventForTree(TreePath[] tps, java.awt.event.MouseEvent evt) {
    ...
    private DefaultMutableTreeNode getCidsRoot(final Connection connection) {
        ...
        try {
            ...
            // -> "select c.name,c.primary_key_field,a.field_name,r.name,r.complex_type from cs_class c ,cs_attr a,cs_type r where c.id=a.class_id and r.id=a.type_id");
            while (rs.next()) {
...
//        private boolean stringVal = false;
    ...
    static class TargetTable extends DefaultMutableTreeNode implements Mapable, Referenceable {
         ...
         */
        public List<Mapping> getMappings() {
            List<Mapping> maps = TypeSafeCollections.newArrayList();
            for (int i = 0; i < getChildCount(); ++i) {
                Mapable mapable = (Mapable) getChildAt(i);
...
//                maps.add(newMapping);
         ...
         */
        public List<Reference> getReferences() {
            List<Reference> rel = TypeSafeCollections.newArrayList();
            //Relations rel=new Relations();
            Reference r;
            for (int i = 0; i < getChildCount(); ++i) {
                TargetField f = (TargetField) getChildAt(i);
                if (f.isForeignKey()) {
                    r = new Reference();
    ...
    private static class DualDataTableTransferable implements Transferable {
        ...
        public boolean isDataFlavorSupported(final DataFlavor flavor) {
            return (flavor.equals(JPDataFlavors.MAP_FLAVOR) && mapable.getMappings() != null && mapable.getMappings().size() > 0) || (flavor.equals(JPDataFlavors.REF_FLAVOR) && relationable.getReferences() != null && relationable.getReferences().size() > 0);
        }
