...
/**
 * Provides all available method public-static method names from the code folder sources for selfmade autocomplete
 * support in mapping table.
 *
 * @author   srichter
...
public class AutoCompleteMethodProvider implements CodeFunctionProvider {
    ...
    /**
     * Creates a new AutoCompleteMethodProvider object.
     *
     * @param  codeDir  DOCUMENT ME!
     */
    ...
    /**
     * Scans java sourcefiles for public-static methods and adds their names to the available-methods-cache.
     *
                ...
                try {
                    javaSource.runUserActionTask(new Task<CompilationController>() {
                            ...
                            public void run(final CompilationController compilationController) throws Exception {
                                ...
                                final List<String> classPSMethods =
                                    new MethodVisitor(compilationController).scan(
