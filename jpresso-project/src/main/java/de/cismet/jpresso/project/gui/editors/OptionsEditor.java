...
public final class OptionsEditor extends javax.swing.JPanel {
    ...
    public OptionsEditor(final RunTopComponent topComponent) {
        ...
        final ResourceBundle res = ResourceBundle.getBundle("de.cismet.jpresso.core.finalizer.finalizer", Locale.getDefault(), Thread.currentThread().getContextClassLoader());
    ...
    public void setTables(String[] withoutPath, String[] withPath) {
...
//                String tmp = name.toUpperCase();
    ...
    public void setContent(Options options, RuntimeProperties runtimeProps) {
        setContent(options);
    ...
    public Options getOptionsContent() {
        ...
        while (it.hasNext()) {
            JCheckBox c = normalizeOptions.get(it.next());
            if (c.isSelected()) {
    ...
    private void initComponents() {
        ...
        panNormalizeTitle.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createTitledBorder(null, "Normalize", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 12), javax.swing.UIManager.getDefaults().getColor("CheckBoxMenuItem.selectionBackground")), javax.swing.BorderFactory.createEmptyBorder(5, 5, 5, 5))); // NOI18N
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createTitledBorder(null, "Finalizer", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 12), javax.swing.UIManager.getDefaults().getColor("CheckBoxMenuItem.selectionBackground")), javax.swing.BorderFactory.createEmptyBorder(5, 5, 5, 5))); // NOI18N
        ...
        panFilterTitle.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createTitledBorder(null, "Filter", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 12), javax.swing.UIManager.getDefaults().getColor("CheckBoxMenuItem.selectionBackground")), javax.swing.BorderFactory.createEmptyBorder(5, 5, 5, 5))); // NOI18N
...
private void cmdFinalizeClassActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFinalizeClassActionPerformed
