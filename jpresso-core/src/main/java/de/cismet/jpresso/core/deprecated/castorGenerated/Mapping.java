...
public class Mapping implements java.io.Serializable {
     ...
     * @param reader
     */
    public static de.cismet.jpresso.core.deprecated.castorGenerated.Mapping unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (de.cismet.jpresso.core.deprecated.castorGenerated.Mapping) Unmarshaller.unmarshal(de.cismet.jpresso.core.deprecated.castorGenerated.Mapping.class, reader);
