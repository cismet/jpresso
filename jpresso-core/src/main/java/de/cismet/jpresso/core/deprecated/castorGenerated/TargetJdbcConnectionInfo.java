...
public class TargetJdbcConnectionInfo implements java.io.Serializable {
     ...
     * @param reader
     */
    public static de.cismet.jpresso.core.deprecated.castorGenerated.TargetJdbcConnectionInfo unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (de.cismet.jpresso.core.deprecated.castorGenerated.TargetJdbcConnectionInfo) Unmarshaller.unmarshal(de.cismet.jpresso.core.deprecated.castorGenerated.TargetJdbcConnectionInfo.class, reader);
