...
public class RuntimeProps implements java.io.Serializable {
     ...
     */
    public void setFinalizer(de.cismet.jpresso.core.deprecated.castorGenerated.Finalizer finalizer)
    {
     ...
     * @param reader
     */
    public static de.cismet.jpresso.core.deprecated.castorGenerated.RuntimeProps unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (de.cismet.jpresso.core.deprecated.castorGenerated.RuntimeProps) Unmarshaller.unmarshal(de.cismet.jpresso.core.deprecated.castorGenerated.RuntimeProps.class, reader);
