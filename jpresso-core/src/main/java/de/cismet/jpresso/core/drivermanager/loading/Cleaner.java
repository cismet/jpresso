...
public final class Cleaner {
    ...
    /**
     * Deregisters all drivers loaded by the same classloader as class to avoid classloader memory leaks due to
     * java.sql.DriverManagers references on the driver. This is needed, because the class that deregisters a driver
     * must be loaded by the same classloader as the driver itself.
     */
