...
public class SourceJdbcConnectionInfo implements java.io.Serializable {
    ...
    public void addProp(de.cismet.jpresso.core.deprecated.castorGenerated.Prop vProp)
    ...
    public void addProp(int index, de.cismet.jpresso.core.deprecated.castorGenerated.Prop vProp)
        throws java.lang.IndexOutOfBoundsException
    {
     ...
     * @param index
     */
    public de.cismet.jpresso.core.deprecated.castorGenerated.Prop getProp(int index)
        throws java.lang.IndexOutOfBoundsException
    {
    ...
    public de.cismet.jpresso.core.deprecated.castorGenerated.Prop[] getProp()
    {
        ...
        de.cismet.jpresso.core.deprecated.castorGenerated.Prop[] mArray = new de.cismet.jpresso.core.deprecated.castorGenerated.Prop[size];
     ...
     * @param index
     */
    public de.cismet.jpresso.core.deprecated.castorGenerated.Prop removeProp(int index)
    {
    ...
    public void setProp(int index, de.cismet.jpresso.core.deprecated.castorGenerated.Prop vProp)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index > _propList.size())) {
    ...
    public void setProp(de.cismet.jpresso.core.deprecated.castorGenerated.Prop[] propArray)
    {
        //-- copy array
        _propList.removeAllElements();
     ...
     * @param reader
     */
    public static de.cismet.jpresso.core.deprecated.castorGenerated.SourceJdbcConnectionInfo unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (de.cismet.jpresso.core.deprecated.castorGenerated.SourceJdbcConnectionInfo) Unmarshaller.unmarshal(de.cismet.jpresso.core.deprecated.castorGenerated.SourceJdbcConnectionInfo.class, reader);
