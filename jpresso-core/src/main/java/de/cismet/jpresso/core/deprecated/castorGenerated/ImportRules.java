...
public class ImportRules implements java.io.Serializable {
     ...
     */
    public void setCode(de.cismet.jpresso.core.deprecated.castorGenerated.Code code)
    {
        this._code = code;
     ...
     */
    public void setConnectionInfo(de.cismet.jpresso.core.deprecated.castorGenerated.ConnectionInfo connectionInfo)
    {
     ...
     */
    public void setOptions(de.cismet.jpresso.core.deprecated.castorGenerated.Options options)
    {
     ...
     */
    public void setPreProcessingAndMapping(de.cismet.jpresso.core.deprecated.castorGenerated.PreProcessingAndMapping preProcessingAndMapping)
    {
     ...
     */
    public void setRelations(de.cismet.jpresso.core.deprecated.castorGenerated.Relations relations)
    {
     ...
     */
    public void setRuntimeProps(de.cismet.jpresso.core.deprecated.castorGenerated.RuntimeProps runtimeProps)
    {
     ...
     * @param reader
     */
    public static de.cismet.jpresso.core.deprecated.castorGenerated.ImportRules unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (de.cismet.jpresso.core.deprecated.castorGenerated.ImportRules) Unmarshaller.unmarshal(de.cismet.jpresso.core.deprecated.castorGenerated.ImportRules.class, reader);
