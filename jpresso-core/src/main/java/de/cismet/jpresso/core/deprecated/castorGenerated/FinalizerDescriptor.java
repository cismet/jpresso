 ...
 * Schema.
 * $Id: FinalizerDescriptor.java,v 1.1 2003/12/01 11:38:00 Hell Exp $
 */
...
/**
 * Class FinalizerDescriptor.
 * 
 * @version $Revision: 1.1 $ $Date: 2003/12/01 11:38:00 $
 */
public class FinalizerDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public FinalizerDescriptor() {
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                Finalizer target = (Finalizer) object;
        ...
        //-- _propList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(de.cismet.jpresso.core.deprecated.castorGenerated.Prop.class, "_propList", "Prop", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
        ...
        desc.setValidator(fieldValidator);
    } //-- de.cismet.cids.admin.importAnt.castorGenerated.FinalizerDescriptor()
    ...
    {
        return de.cismet.jpresso.core.deprecated.castorGenerated.Finalizer.class;
