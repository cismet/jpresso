...
public class Relations implements java.io.Serializable {
    ...
    public void addRelation(de.cismet.jpresso.core.deprecated.castorGenerated.Relation vRelation)
    ...
    public void addRelation(int index, de.cismet.jpresso.core.deprecated.castorGenerated.Relation vRelation)
        throws java.lang.IndexOutOfBoundsException
    {
     ...
     * @param index
     */
    public de.cismet.jpresso.core.deprecated.castorGenerated.Relation getRelation(int index)
        throws java.lang.IndexOutOfBoundsException
    {
    ...
    public de.cismet.jpresso.core.deprecated.castorGenerated.Relation[] getRelation()
    {
        ...
        de.cismet.jpresso.core.deprecated.castorGenerated.Relation[] mArray = new de.cismet.jpresso.core.deprecated.castorGenerated.Relation[size];
     ...
     * @param index
     */
    public de.cismet.jpresso.core.deprecated.castorGenerated.Relation removeRelation(int index)
    {
    ...
    public void setRelation(int index, de.cismet.jpresso.core.deprecated.castorGenerated.Relation vRelation)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index > _relationList.size())) {
    ...
    public void setRelation(de.cismet.jpresso.core.deprecated.castorGenerated.Relation[] relationArray)
    {
        //-- copy array
        _relationList.removeAllElements();
     ...
     * @param reader
     */
    public static de.cismet.jpresso.core.deprecated.castorGenerated.Relations unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (de.cismet.jpresso.core.deprecated.castorGenerated.Relations) Unmarshaller.unmarshal(de.cismet.jpresso.core.deprecated.castorGenerated.Relations.class, reader);
